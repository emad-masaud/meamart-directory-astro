                  ...
                  <div className="px-6 pb-8 border-t border-foreground/10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                       {localizedLinks.map((link) => (
                         ...
                         >
                            <div className="w-8 h-8 rounded-lg bg-background border border-foreground/10 flex items-center justify-center text-foreground group-hover:gradient-text transition-colors">
                               <link.icon size={16} />
                            </div>
                            <span className="text-sm font-bold text-foreground group-hover:gradient-text">{link.label}</span>
                         </a>
                       ))}
                    </div>
                  </div>
